...
echo.
echo ========================================
echo Building main.cpp (OpenMP + SDL3)
echo ========================================

cl.exe main.cpp /EHsc /openmp /Fe:main.exe ^
    /I"C:\SDL2\SDL3-3.2.26\SDL3-3.2.26\include" ^
    /link ^
    /LIBPATH:"C:\SDL2\SDL3-3.2.26\SDL3-3.2.26\VisualC\x64\Release" ^
    SDL3.lib
...
if %errorlevel% neq 0 (
    ...
    echo 1. Visual Studio with C++ compiler
    echo 2. OpenMP support enabled
